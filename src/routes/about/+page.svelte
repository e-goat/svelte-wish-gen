...
<svelte:head>
    ...
    <meta
        name="description"
        content="Научете за KartichkaQR - български екип, който революционизира поздравителните картички с QR кодове и гласови съобщения. Мисия, ценности и визия за свързване на хората чрез технологии. Learn about KartichkaQR - Bulgarian team revolutionizing greeting cards with QR codes and voice messages."
    />
</svelte:head>
            ...
            >
                <div class="text-center mb-8 sm:mb-10">
                    ...
                    >
                        ...
                        и докосва сърца. Ние не просто създаваме картички – ние
                        изграждаме моменти, които имат значение."
                    </p>
                </div>
